    ...
    <div id="header">
        ...
        <div id="menu">
            <ul>
                ...
                <li><a href="article.about.php">关于我们</a></li>
                <li><a href="article.contact.php">联系我们</a></li>
            </ul>
        </div>
    </div>
    <!-- end header -->
    ...
    <div id="content">
        <?php
            if(empty($data)){
              ...
              ?>
                    <div class="post">
                        <h1 class="title"><!--文章标题放置到这里--><?php echo $value['title']?><span style="color:#ccc;font-size:14px;">作者：<!--作者放置到这里--><?php echo $value['author']?></span></h1>
                        <div class="entry">
